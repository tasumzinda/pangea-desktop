 ...
 */
@Entity
public class TbArt extends GenericTB {
    ...
    private Long newOnART;
    private Long alreadyOnART;
    private Long denomNewOnART;
    private Long denomAlreadyOnART;
    ...
    public Long getNewOnART() {
        return newOnART;
    }

    public void setNewOnART(Long newOnART) {
        this.newOnART = newOnART;
    }

    public Long getAlreadyOnART() {
        return alreadyOnART;
    }

    public void setAlreadyOnART(Long alreadyOnART) {
        this.alreadyOnART = alreadyOnART;
    }

    public Long getDenomNewOnART() {
        return denomNewOnART;
    }

    public void setDenomNewOnART(Long denomNewOnART) {
        this.denomNewOnART = denomNewOnART;
    }

    public Long getDenomAlreadyOnART() {
        return denomAlreadyOnART;
    }

    public void setDenomAlreadyOnART(Long denomAlreadyOnART) {
        this.denomAlreadyOnART = denomAlreadyOnART;
    }
