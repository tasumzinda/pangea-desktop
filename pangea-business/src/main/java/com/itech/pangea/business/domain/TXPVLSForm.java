...
@Entity
public class TXPVLSForm extends BaseEntity {
    ...
    private Long routineNumeratorPregnant;
    private Long routineDenominatorPregnant;
    private Long routineDenominatorBreastFeeding;
    private Long routineNumeratorBreastFeeding;
    private Long targetNumeratorPregnant;
    private Long targetDenominatorPregnant;
    private Long targetDenominatorBreastFeeding;
    private Long targetNumeratorBreastFeeding;
    private Long targetBreastFeeding;
    ...
    public Long getRoutineNumeratorPregnant() {
        return routineNumeratorPregnant;
    }

    public void setRoutineNumeratorPregnant(Long routineNumeratorPregnant) {
        this.routineNumeratorPregnant = routineNumeratorPregnant;
    }

    public Long getRoutineDenominatorPregnant() {
        return routineDenominatorPregnant;
    }

    public void setRoutineDenominatorPregnant(Long routineDenominatorPregnant) {
        this.routineDenominatorPregnant = routineDenominatorPregnant;
    }

    public Long getRoutineDenominatorBreastFeeding() {
        return routineDenominatorBreastFeeding;
    }

    public void setRoutineDenominatorBreastFeeding(Long routineDenominatorBreastFeeding) {
        this.routineDenominatorBreastFeeding = routineDenominatorBreastFeeding;
    }

    public Long getRoutineNumeratorBreastFeeding() {
        return routineNumeratorBreastFeeding;
    }

    public void setRoutineNumeratorBreastFeeding(Long routineNumeratorBreastFeeding) {
        this.routineNumeratorBreastFeeding = routineNumeratorBreastFeeding;
    }

    public Long getTargetNumeratorPregnant() {
        return targetNumeratorPregnant;
    }

    public void setTargetNumeratorPregnant(Long targetNumeratorPregnant) {
        this.targetNumeratorPregnant = targetNumeratorPregnant;
    }

    public Long getTargetDenominatorPregnant() {
        return targetDenominatorPregnant;
    }

    public void setTargetDenominatorPregnant(Long targetDenominatorPregnant) {
        this.targetDenominatorPregnant = targetDenominatorPregnant;
    }

    public Long getTargetDenominatorBreastFeeding() {
        return targetDenominatorBreastFeeding;
    }

    public void setTargetDenominatorBreastFeeding(Long targetDenominatorBreastFeeding) {
        this.targetDenominatorBreastFeeding = targetDenominatorBreastFeeding;
    }

    public Long getTargetNumeratorBreastFeeding() {
        return targetNumeratorBreastFeeding;
    }

    public void setTargetNumeratorBreastFeeding(Long targetNumeratorBreastFeeding) {
        this.targetNumeratorBreastFeeding = targetNumeratorBreastFeeding;
    }

    public Long getTargetBreastFeeding() {
        return targetBreastFeeding;
    }

    public void setTargetBreastFeeding(Long targetBreastFeeding) {
        this.targetBreastFeeding = targetBreastFeeding;
    }
