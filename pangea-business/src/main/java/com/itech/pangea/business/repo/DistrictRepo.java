 ...
 */
public interface DistrictRepo extends AbstractNameDescRepo<District, Long> {
    
    public List<District> findByProvince(Province province);
    
    @Query("from District d left join fetch d.province where d.active=:active Order By d.name ASC")
