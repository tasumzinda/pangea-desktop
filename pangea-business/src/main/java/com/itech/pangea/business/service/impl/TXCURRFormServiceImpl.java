...
import com.itech.pangea.business.domain.TXCURRForm;
import com.itech.pangea.business.repo.TXCURRFormRepo;
import com.itech.pangea.business.service.TXCURRFormService;
...
public class TXCURRFormServiceImpl implements TXCURRFormService {
    
    @Resource
    private TXCURRFormRepo tXCURRFormRepo;
    @PersistenceContext
    private EntityManager entityManager;
    
    @Override
    public List<TXCURRForm> getAll(){
        return tXCURRFormRepo.findAll();
    }
    
    @Override
    @Transactional
    public TXCURRForm save(TXCURRForm t) {
        if (t.getId() == null) {
            t.setDateCreated(new Date());
            return tXCURRFormRepo.save(t);
        }
    ...
    public Long get(SearchNationalDTO dto, String colName) {
        StringBuilder builder = new StringBuilder("Select sum(p."+colName+") from TXCURRForm p");
        int position = 0;
