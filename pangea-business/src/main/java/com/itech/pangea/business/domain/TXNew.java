 ...
 */
@Entity
public class TXNew extends BaseEntity{
    ...
    private Long fsw;
    private Long prisonAndEnclosedSettings;*/
    private Long confirmedTB;
    @Transient
    ...
    public Long getConfirmedTB() {
        return confirmedTB;
    }

    public void setConfirmedTB(Long confirmedTB) {
