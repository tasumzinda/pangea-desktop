 ...
 */
@Configuration
@ComponentScan(basePackages = {"com.itech.pangea.client*",
    "com.itech.pangea.business.service.impl"})
@PropertySource("classpath:application.properties")
@EnableJpaRepositories(basePackages = {"com.itech.pangea.business.repo"})
public class SpringConfig {
   ...
   //  private static final String PROPERTY_NAME_HIBERNATE_GENERATEDDL = "hibernate.generate-ddl";
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() throws ClassNotFoundException {
     ...
     //   jpaProterties.put(PROPERTY_NAME_HIBERNATE_GENERATEDDL, environment.getRequiredProperty(PROPERTY_NAME_HIBERNATE_GENERATEDDL));
